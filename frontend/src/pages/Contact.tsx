  ...
  return (
    <>
      ...
      <section className="section-shell border-y border-[#E0D7C6] bg-[#F4EFE6]" data-testid="contact-maps-section">
        <SectionHeading eyebrow="Visit or get directions" title="Our office and factory locations." body="The Delhi map points to Pronod Tech, Sawan Park, while the crawlable office address remains shown below." />
        <div className="mt-10 grid gap-6 lg:grid-cols-2">
          <div className="overflow-hidden border border-[#E0D7C6] bg-white" data-testid="delhi-map-card">
            <iframe title="Map showing Pronod Tech in Sawan Park near the Delhi office" src="https://www.google.com/maps?q=Pronod%20Tech%2C%20Sawan%20Park%2C%20Delhi&output=embed" loading="lazy" className="h-64 w-full border-0 grayscale" data-testid="delhi-map-iframe" />
            <div className="flex items-center justify-between gap-4 p-5"><p className="text-sm font-bold" data-testid="delhi-map-address">Delhi Office · K-11, Sawan Park, Ashok Vihar - Phase 3, Delhi - 110052, Near Picnic Hut</p><a href="https://www.google.com/maps/search/?api=1&query=Pronod%20Tech%2C%20Sawan%20Park%2C%20Delhi" target="_blank" rel="noopener noreferrer" className="shrink-0 text-xs font-bold text-[#183A2B]" data-testid="delhi-map-directions">Directions</a></div>
          </div>
          <div className="overflow-hidden border border-[#E0D7C6] bg-white" data-testid="yamuna-map-card">
            <iframe title="Map showing Yamuna Nagar factory location" src="https://www.google.com/maps?q=Plot%20No.%2042%2C%20Industrial%20Estate%20Phase-II%2C%20Yamuna%20Nagar%20-%20135001%20%28Haryana%29&output=embed" loading="lazy" className="h-64 w-full border-0 grayscale" data-testid="yamuna-map-iframe" />
            <div className="flex items-center justify-between gap-4 p-5"><p className="text-sm font-bold" data-testid="yamuna-map-address">Yamuna Nagar Factory · Plot No. 42, Industrial Estate Phase-II, Yamuna Nagar - 135001 (Haryana)</p><a href="https://www.google.com/maps/search/?api=1&query=Plot%20No.%2042%2C%20Industrial%20Estate%20Phase-II%2C%20Yamuna%20Nagar%20-%20135001%20%28Haryana%29" target="_blank" rel="noopener noreferrer" className="shrink-0 text-xs font-bold text-[#183A2B]" data-testid="yamuna-map-directions">Directions</a></div>
          </div>
        </div>
      </section>
    </>
